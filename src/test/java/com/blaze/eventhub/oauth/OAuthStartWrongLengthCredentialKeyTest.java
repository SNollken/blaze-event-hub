...
@SpringBootTest(properties = {
        ...
        "eventhub.security.credential-encryption-key=c2hvcnQ="
})
@AutoConfigureMockMvc
class OAuthStartWrongLengthCredentialKeyTest {
    ...
    @Test
    void rejectsWrongLengthCredentialEncryptionKeyBeforeCallingBlaze() throws Exception {
