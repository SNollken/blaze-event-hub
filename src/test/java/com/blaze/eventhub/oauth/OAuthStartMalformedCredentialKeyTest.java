...
@SpringBootTest(properties = {
        ...
        "eventhub.security.credential-encryption-key=not-valid-base64!"
})
@AutoConfigureMockMvc
class OAuthStartMalformedCredentialKeyTest {
    ...
    @Test
    void rejectsMalformedCredentialEncryptionKeyBeforeCallingBlaze() throws Exception {
        mockMvc.perform(get("/api/blaze/oauth/start").accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.message", allOf(
                        containsString("EVENTHUB_CREDENTIAL_ENCRYPTION_KEY"),
                        containsString("Base64"),
                        containsString("32 bytes"))));
